...
This change does not implement ECC 000-140 field semantics or encoders. It also
does not redesign the generic string-based ZPL input/charset pipeline: literal
